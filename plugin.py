...
from ...plugins.mailjet.tasks import send_email_with_dynamic_template_id
...
HELP_TEXT_TEMPLATE = "ID of the dynamic template in Mailjet"


class MailjetEmailPlugin(BasePlugin):
    PLUGIN_ID = "canimal.notifications.mailjet_email"
    PLUGIN_NAME = "Mailjet"
    ...
    CONFIG_STRUCTURE = {
        ...
        "api_key": {
            ...
            "help_text": "Your Mailjet API key.",
            "label": "API key",
        },
         "secret_key": {
            "type": ConfigurationTypeField.SECRET,
            "help_text": "Your Mailjet API secret key.",
            "label": "Secret key",
        },
    }
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.config = MailjetConfiguration(**configuration)
    ...
    def validate_plugin_configuration(
        ...
        if not api_key:
            error_msg = "Missing Mailjet API Key"
